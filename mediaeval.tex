...
Inter-cluster and intra-cluster ranking forms the basis of this method and is inspired by \cite{representativeness}.
...
\begin{table}[H]
\centering
\caption{Results on subset of 50 locations from test set (in \%) with crowd-sourced ground truth.}
...
Table \ref{tbl:crowd-results} lists the results on 50 locations of the test set evaluated with three crowd-sourced ground truths.
